...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //instantiere Book
        Book b = new Book();
        //folosirea seterilor pt popularea campurilor/atributelor obiectului b de tip Book
        b.setNrPagini(12);
        ...
        //folosirea seterului pt popularea campurilor/atributelor obiectului art de tip ArtAlbum
        art.setCalitateHartie("awsome");

        SculptureAlbum sculpture = new SculptureAlbum();
        sculpture.setGen("bronz");

        //instantiere Novel
        Novel nov = new Novel();
        //folosirea seterului pt popularea campurilor/atributelor obiectului nov de tip Novel
        nov.setType("action");
